const questions = [
  ...
  },
  {
    ...
    type: "multiple",
    difficulty: "easy",
    question: "In the programming language Java, which of these keywords would you put on a variable to make sure it doesn't &#039;t get modified?",
...
const load = () => {
  window.onload = function () {
    ...
    const showFinalScore = () => {
      ...
      footerText.innerHTML = "Hai risposto correttamente a " + correctAnswers + " su " + totalQuestions + " domande.";
